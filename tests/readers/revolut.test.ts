...
test("reader", async () => {
  ...
  expect(txs).toEqual([
    {
      date: parseISO("2025-02-20T07:15:30.000Z"),
      currency: "CHF",
      amount: 900,
      balance: 1100.5,
    ...
    {
      date: parseISO("2025-02-22T08:30:10.000Z"),
      currency: "CHF",
      amount: -4.5,
      balance: 1096,
    ...
    {
      date: parseISO("2025-02-23T11:20:45.000Z"),
      currency: "CHF",
      amount: -45.3,
      balance: 1050.7,
    ...
    {
      date: parseISO("2025-02-24T13:15:30.000Z"),
      currency: "CHF",
      amount: -85,
      balance: 965.7,
    ...
    {
      date: parseISO("2025-02-25T09:50:22.000Z"),
      currency: "CHF",
      amount: -32.75,
      balance: 932.95,
